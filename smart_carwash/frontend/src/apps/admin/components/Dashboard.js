...
const Dashboard = () => {
  ...
  const sections = [
    ...
    {
      title: 'Настройки',
      description: 'Управление ценами услуг и системными настройками автомойки.',
      icon: '⚙️',
      path: '/admin/settings'
    },
    {
      title: 'Платежи',
      description: 'Просмотр и управление платежами с фильтрацией по статусу, типу и дате.',
      icon: '💳',
      path: '/admin/payments'
    }
  ];
