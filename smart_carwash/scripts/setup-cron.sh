...
# Создаем cron job для еженедельной очистки Docker (каждое воскресенье в 2:00)
(crontab -l 2>/dev/null; echo "0 2 * * 0 /home/artem/smart_carwash/smart_carwash/scripts/docker-cleanup.sh") | crontab -
...
echo "- Еженедельная очистка Docker: воскресенье 2:00"
